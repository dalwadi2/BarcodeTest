...
public class AndroidBarcodeView extends View {
    ...
    public AndroidBarcodeView(Context context) {
        super(context);
        SharedPreferences mypref = context.getSharedPreferences("MyCodeSettings", Context.MODE_PRIVATE);
        ss = mypref.getString("mygeneratedata", "No data");
    }
